...
RETURNS SETOF record AS '$libdir/trade_lookup', 'TradeLookupFrame1'
...
CREATE OR REPLACE FUNCTION TradeLookupFrame2 (
		...
		OUT trade_price NUMERIC(8,2)[])
RETURNS SETOF record AS '$libdir/trade_lookup', 'TradeLookupFrame2'
LANGUAGE C IMMUTABLE STRICT;
...
RETURNS SETOF record AS '$libdir/trade_lookup', 'TradeLookupFrame3'
LANGUAGE C IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION TradeLookupFrame4 (
		...
		OUT status INTEGER,
		OUT trade_id BIGINT)
RETURNS SETOF record AS '$libdir/trade_lookup', 'TradeLookupFrame4'
LANGUAGE C IMMUTABLE STRICT;
