...
RETURNS SETOF record AS '$libdir/trade_order', 'TradeOrderFrame1'
...
CREATE OR REPLACE FUNCTION TradeOrderFrame2 (
		...
		OUT status INTEGER)
RETURNS SETOF record AS '$libdir/trade_order', 'TradeOrderFrame2'
LANGUAGE C IMMUTABLE STRICT;
...
RETURNS SETOF record AS '$libdir/trade_order', 'TradeOrderFrame3'
LANGUAGE C IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION TradeOrderFrame4 (
		...
		OUT status INTEGER,
		OUT trade_id BIGINT)
RETURNS SETOF record AS '$libdir/trade_order', 'TradeOrderFrame4'
LANGUAGE C IMMUTABLE STRICT;
