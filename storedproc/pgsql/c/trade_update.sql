...
RETURNS SETOF record AS '$libdir/trade_update', 'TradeUpdateFrame1'
...
CREATE OR REPLACE FUNCTION TradeUpdateFrame2 (
		...
		OUT trade_price NUMERIC(8,2)[])
RETURNS SETOF record AS '$libdir/trade_update', 'TradeUpdateFrame2'
LANGUAGE C IMMUTABLE STRICT;
...
RETURNS SETOF record AS '$libdir/trade_update', 'TradeUpdateFrame3'
LANGUAGE C IMMUTABLE STRICT;
