...
RETURNS SETOF record AS '$libdir/trade_result', 'TradeResultFrame1'
...
RETURNS SETOF record AS '$libdir/trade_result', 'TradeResultFrame2'
LANGUAGE C IMMUTABLE STRICT;
...
RETURNS SETOF record AS '$libdir/trade_result', 'TradeResultFrame3'
LANGUAGE C IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION TradeResultFrame4 (
		...
		OUT status INTEGER)
RETURNS SETOF record AS '$libdir/trade_result', 'TradeResultFrame4'
LANGUAGE C IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION TradeResultFrame5 (
		...
		IN trade_price NUMERIC(8, 2),
		OUT status INTEGER)
RETURNS INTEGER AS '$libdir/trade_result', 'TradeResultFrame5'
LANGUAGE C IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION TradeResultFrame6 (
		...
		OUT status INTEGER)
RETURNS SETOF record AS '$libdir/trade_result', 'TradeResultFrame6'
LANGUAGE C IMMUTABLE STRICT;
