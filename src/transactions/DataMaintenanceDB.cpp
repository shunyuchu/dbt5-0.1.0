		...
		TDataMaintenanceFrame1Output *pOut)
{
	...
	m_coutLock.unlock();
#endif // DEBUG
    cout<<"DataMaintenance DoDataMaintenanceFrame1() step1"<<endl;
	startTransaction();

	cout<<"DataMaintenance DoDataMaintenanceFrame1() step2"<<endl;
	// Isolation level required by Clause 7.4.1.3
	setReadCommitted();

    cout<<"DataMaintenance DoDataMaintenanceFrame1() step3"<<endl;
	execute(pIn, pOut);

    cout<<"DataMaintenance DoDataMaintenanceFrame1() step4"<<endl;
	commitTransaction();

    cout<<"DataMaintenance DoDataMaintenanceFrame1() end"<<endl;
